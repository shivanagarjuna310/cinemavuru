      ...
      <main className="relative z-10 min-h-screen text-[color:var(--text)] pt-16">
        <div className="max-w-3xl mx-auto px-6 py-12">
          ...
          <div className="flex items-center gap-2 text-xs text-[color:var(--muted)] uppercase tracking-widest mb-8">
            ...
            <span>›</span>
            <span className="text-[color:var(--accent)]">Terms of Service</span>
          </div>

          <h1 className="text-3xl font-bold text-[color:var(--accent)] mb-2">Terms of Service</h1>
          ...
          <div className="space-y-8 text-[color:var(--muted)] leading-relaxed text-sm">
            ...
            <section>
              <h2 className="text-lg font-bold text-[color:var(--text)] mb-3">1. Acceptance of Terms</h2>
            ...
            <section>
              <h2 className="text-lg font-bold text-[color:var(--text)] mb-3">2. What CinemaVuru Is</h2>
            ...
            <section>
              <h2 className="text-lg font-bold text-[color:var(--text)] mb-3">3. User Accounts</h2>
            ...
            <section>
              <h2 className="text-lg font-bold text-[color:var(--text)] mb-3">4. Content Upload Rules</h2>
            ...
            <section>
              <h2 className="text-lg font-bold text-[color:var(--text)] mb-3">5. Contest Rules</h2>
              <ul className="list-disc list-inside space-y-2">
            ...
            <section>
              <h2 className="text-lg font-bold text-[color:var(--text)] mb-3">6. Payments</h2>
            ...
            <section>
              <h2 className="text-lg font-bold text-[color:var(--text)] mb-3">7. Intellectual Property</h2>
            ...
            <section>
              <h2 className="text-lg font-bold text-[color:var(--text)] mb-3">8. Limitation of Liability</h2>
            ...
            <section>
              <h2 className="text-lg font-bold text-[color:var(--text)] mb-3">9. Changes to Terms</h2>
            ...
            <section>
              <h2 className="text-lg font-bold text-[color:var(--text)] mb-3">10. Governing Law</h2>
          ...
          <div className="mt-12 pt-8 border-t border-[color:var(--border)] flex gap-6 text-sm">
            <Link href="/privacy" className="text-[color:var(--muted)] hover:text-[color:var(--accent)] transition">Privacy Policy</Link>
