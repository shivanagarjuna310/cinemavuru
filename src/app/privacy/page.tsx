      ...
      <main className="relative z-10 min-h-screen text-[color:var(--text)] pt-16">
        <div className="max-w-3xl mx-auto px-6 py-12">
          ...
          <div className="flex items-center gap-2 text-xs text-[color:var(--muted)] uppercase tracking-widest mb-8">
            ...
            <span>›</span>
            <span className="text-[color:var(--accent)]">Privacy Policy</span>
          </div>

          <h1 className="text-3xl font-bold text-[color:var(--accent)] mb-2">Privacy Policy</h1>
          <p className="text-[color:var(--muted)] text-sm mb-10">Last updated: April 2026</p>

          <div className="space-y-8 text-[color:var(--muted)] leading-relaxed text-sm">

            <section>
              <h2 className="text-lg font-bold text-[color:var(--text)] mb-3">1. Introduction</h2>
            ...
            <section>
              <h2 className="text-lg font-bold text-[color:var(--text)] mb-3">2. Information We Collect</h2>
              <p className="mb-3">We collect the following types of information:</p>
              <div className="space-y-4">
                <div>
                  <h3 className="text-[color:var(--text)] font-semibold mb-1">Account Information</h3>
                  <p>When you register, we collect your name and email address. This is used to create and manage your account.</p>
                </div>
                <div>
                  <h3 className="text-[color:var(--text)] font-semibold mb-1">Film & Content Data</h3>
                  <p>When you upload a film, we store the film title, description, genre, YouTube URL, and associated metadata you provide.</p>
                </div>
                <div>
                  <h3 className="text-[color:var(--text)] font-semibold mb-1">Usage Data</h3>
                ...
                <div>
                  <h3 className="text-[color:var(--text)] font-semibold mb-1">Payment Data</h3>
            ...
            <section>
              <h2 className="text-lg font-bold text-[color:var(--text)] mb-3">3. How We Use Your Information</h2>
            ...
            <section>
              <h2 className="text-lg font-bold text-[color:var(--text)] mb-3">4. Data Storage & Security</h2>
            ...
            <section>
              <h2 className="text-lg font-bold text-[color:var(--text)] mb-3">5. Third-Party Services</h2>
              <p className="mb-3">We use the following third-party services that may process your data:</p>
              <ul className="list-disc list-inside space-y-2">
                <li><span className="text-[color:var(--text)]">Supabase</span> — database and authentication</li>
                <li><span className="text-[color:var(--text)]">Razorpay</span> — payment processing</li>
                <li><span className="text-[color:var(--text)]">Resend</span> — transactional email delivery</li>
                <li><span className="text-[color:var(--text)]">Vercel</span> — website hosting</li>
                <li><span className="text-[color:var(--text)]">YouTube</span> — video embedding (videos hosted on YouTube are subject to Google's privacy policy)</li>
              </ul>
            </section>

            <section>
              <h2 className="text-lg font-bold text-[color:var(--text)] mb-3">6. Cookies</h2>
            ...
            <section>
              <h2 className="text-lg font-bold text-[color:var(--text)] mb-3">7. Your Rights</h2>
              ...
              <p className="mt-3">To exercise any of these rights, contact us at <a href="mailto:shivanagarjuna777@gmail.com" className="text-[color:var(--accent)] hover:underline">shivanagarjuna777@gmail.com</a>.</p>
            </section>

            <section>
              <h2 className="text-lg font-bold text-[color:var(--text)] mb-3">8. Data Retention</h2>
            ...
            <section>
              <h2 className="text-lg font-bold text-[color:var(--text)] mb-3">9. Children's Privacy</h2>
            ...
            <section>
              <h2 className="text-lg font-bold text-[color:var(--text)] mb-3">10. Changes to This Policy</h2>
            ...
            <section>
              <h2 className="text-lg font-bold text-[color:var(--text)] mb-3">11. Contact Us</h2>
          ...
          {/* Footer links */}
          <div className="mt-12 pt-8 border-t border-[color:var(--border)] flex gap-6 text-sm">
            <Link href="/terms" className="text-[color:var(--muted)] hover:text-[color:var(--accent)] transition">Terms of Service</Link>
            <Link href="/" className="text-[color:var(--muted)] hover:text-[color:var(--accent)] transition">← Back to Home</Link>
          </div>
