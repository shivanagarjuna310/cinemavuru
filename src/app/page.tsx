...
export default async function Home() {
  const { districts, contest, totalUsers, totalFilms, topFilms, mostLiked, monthlyFilms, monthName } = await getData()
        ...
        {monthlyFilms.length > 0 && (
          <section className="max-w-6xl mx-auto px-6 pb-12">
            ...
            <h2 className="text-2xl font-bold text-white mb-1"
              style={{fontFamily: "'Georgia', serif"}}>
              🗓️ Top Films of {monthName}
            </h2>
            <p className="text-[#A5A5A5] text-xs mb-6">Films uploaded this month · Resets every month · Top film wins ₹2,000 + promo interview</p>
                  ...
                  >
                    ...
                    <div className="absolute -left-4 bottom-12 text-9xl font-black select-none z-10 leading-none"
                      style={{
                        fontFamily: "'Georgia', serif",
                        color: 'transparent',
                        WebkitTextStroke: '2px rgba(74,144,226,0.5)',
                      }}>
                      {index + 1}
                    </div>
                    ...
                    {/* Film info */}
                    <div className="mt-2 ml-5">
                      <p className="text-white text-xs font-bold leading-tight line-clamp-2 group-hover:text-[#4A90E2] transition-colors">
                        {film.title_en}
                      </p>
